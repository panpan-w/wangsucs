...
class Fmgr {
    ...
    public function fetch($fops) {
        ...
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/fetch";
    ...
    public function copy($fops) {
        ...
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/copy";
    ...
    public function move($fops) {
        ...
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/move";
    ...
    public function delete($fops) {
        ...
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/delete";
    ...
    public function deleteM3u8($fops) {
        ...
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/deletem3u8";
    ...
    public function deletePrefix($fops) {
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/deletePrefix";
    ...
    public function compress($fops) {
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/compress";
    ...
    public function status($persistentId) {
        $url = Utils::parse_url($this->config->wcs_mgr_url()) . "/fmgr/status?persistentId=" . $persistentId;
